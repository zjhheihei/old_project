...
{
    INT8U CalcCRC[2]; 
    crc16Make(&dat[0],(len - 2),&CalcCRC[0]);
    if((CalcCRC[0] == dat[len - 2]) && (CalcCRC[1] == dat[len - 1]))
    {
        return BN_TRUE;
    }
    return BN_FALSE;
...
{
    INT8U CalcCRC[2]; 
    crc16Make_small(&dat[0],(len - 2),&CalcCRC[0]);
    if((CalcCRC[0] == dat[len - 2]) && (CalcCRC[1] == dat[len - 1]))
    {
        return BN_TRUE;
    }
...
{
    INT8U CalcCRC[2]; 
    crc16Make_big(&dat[0],(len - 2),&CalcCRC[0]);
    if((CalcCRC[0] == dat[len - 2]) && (CalcCRC[1] == dat[len - 1]))
    {
        return BN_TRUE;
    }
