...
#define READ_KEY1      PC_IDR_IDR7
#define KEY1_PIN_ODR   PC_ODR_ODR7
#define KEY1_PIN_DDR   PC_DDR_DDR7
#define KEY1_PIN_CR1   PC_CR1_C17
#define KEY1_PIN_CR2   PC_CR2_C27
#define key1Init()     KEY1_PIN_DDR = 0;  KEY1_PIN_CR1 = 1; KEY1_PIN_CR2 = 0; KEY1_PIN_ODR = 1
 
#endif

#ifdef __KEY_2_ENBALE__
#define READ_KEY2      PE_IDR_IDR6
#define KEY2_PIN_ODR   PE_ODR_ODR6
#define KEY2_PIN_DDR   PE_DDR_DDR6
#define KEY2_PIN_CR1   PE_CR1_C16
#define KEY2_PIN_CR2   PE_CR2_C26
#define key2Init()     KEY2_PIN_DDR = 0;  KEY2_PIN_CR1 = 1; KEY2_PIN_CR2 = 0; KEY2_PIN_ODR = 1 
#endif

#ifdef __KEY_3_ENBALE__
#define READ_KEY3      PC_IDR_IDR4
#define KEY3_PIN_ODR   PC_ODR_ODR4
#define KEY3_PIN_DDR   PC_DDR_DDR4
#define KEY3_PIN_CR1   PC_CR1_C14
#define KEY3_PIN_CR2   PC_CR2_C24
#define key3Init()     KEY3_PIN_DDR = 0;  KEY3_PIN_CR1 = 1; KEY3_PIN_CR2 = 0; KEY3_PIN_ODR = 1 
#endif

#ifdef __KEY_4_ENBALE__
#define READ_KEY4      PA_IDR_IDR2
#define KEY4_PIN_ODR   PA_ODR_ODR2
#define KEY4_PIN_DDR   PA_DDR_DDR2
#define KEY4_PIN_CR1   PA_CR1_C12
#define KEY4_PIN_CR2   PA_CR2_C22
#define key4Init()     KEY4_PIN_DDR = 0;  KEY4_PIN_CR1 = 1; KEY4_PIN_CR2 = 0; KEY4_PIN_ODR = 1 
#endif

#ifdef __KEY_5_ENBALE__
#define READ_KEY5      PA_IDR_IDR3
#define KEY5_PIN_ODR   PA_ODR_ODR3
#define KEY5_PIN_DDR   PA_DDR_DDR3
#define KEY5_PIN_CR1   PA_CR1_C13
#define KEY5_PIN_CR2   PA_CR2_C23
#define key5Init()     KEY5_PIN_DDR = 0;  KEY5_PIN_CR1 = 1; KEY5_PIN_CR2 = 0; KEY5_PIN_ODR = 1 
#endif
...
void bsp_key_cofigure(INT16U *_out_keyGroup)
{
    ...
    _out_keyGroup[1] = KeyAloneBit3 | KeyAloneBit0;
