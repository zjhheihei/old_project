...
#define PRODUCT_KEY "ec0hrya0qbp48whq"  
#define MCU_VER "1.0.2"
...
//开窗开关(可下发可上报)
//备注:开 或 关
#define DPID_OPEN_WINDOW_SWITCH 8
...
//开窗状态(只上报)
//备注:开 或 关
#define DPID_OPEN_WINDOW_STATUS 25
...
//周程序（自由式）(可下发可上报)
//备注:
#define DPID_WEEK_PROGRAM1 38
//童锁开关(可下发可上报)
//备注:
#define DPID_CHILD_LOCK 40
//传感器选择(可下发可上报)
//备注:
#define DPID_SENSOR_CHOOSE 43
//故障告警(只上报)
//备注:
#define DPID_FAULT 45
//保留(可下发可上报)
//备注:备用数据
#define DPID_RESERVE 101
//寄存器透传(可下发可上报)
//备注:数据以寄存器的形式透传
#define DPID_REG_RAW 102
//保留_char(可下发可上报)
//备注:字符型传输保留
#define DPID_RESERVE_CHAR 103
//地面温度(可下发可上报)
//备注:
#define DPID_FLOORTEMP 104
//地面传感器类型(可下发可上报)
//备注:
#define DPID_FLOORSENSERTYPE 105
//地面温度限值(可下发可上报)
//备注:
#define DPID_FLOORLIMITTEMP 106
//防冻状态(可下发可上报)
//备注:1,防冻开启
#define DPID_NOTFROZEN 107
